...
# DVE full session
# Saved on Sat Nov 3 09:12:14 2012
# Designs open: 1
#   Sim: /share/jinz/Synopsys_Tutorial/vcsmx_example/testbench/sv/uvm/testbench.in/uvm_callback_2/simv
...
#<Session mode="Full" path="/share/jinz/Synopsys_Tutorial/vcsmx_example/testbench/sv/uvm/testbench.in/uvm_callback_2/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{4 26} {1656 934}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 310} {height 603} {dock_state left} {dock_on_new_line true} {child_hier_colhier 470} {child_hier_coltype 108} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 479} {height 603} {dock_state left} {dock_on_new_line true} {child_data_colvariable 227} {child_data_colvalue 73} {child_data_coltype 171} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 188]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1620
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 188
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1652} {height 187} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/share/jinz/Synopsys_Tutorial/vcsmx_example/testbench/sv/uvm/testbench.in/uvm_callback_2/simv}] } {
gui_sim_run Ucli -exe simv -args { -ucligui} -dir /share/jinz/Synopsys_Tutorial/vcsmx_example/testbench/sv/uvm/testbench.in/uvm_callback_2 -nosource
}
}
...
gui_open_source -id ${Source.1}  -replace -active test /share/jinz/Synopsys_Tutorial/vcsmx_example/testbench/sv/uvm/testbench.in/uvm_callback_2/test1.sv
