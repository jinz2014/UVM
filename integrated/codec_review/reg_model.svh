...
class reg_IntSrc extends uvm_reg;
   ...
   uvm_reg_field TxEmpty;  // default value is 1
   uvm_reg_field TxLow;  // default value is 1
   uvm_reg_field TxFull;  // default value is 0
   uvm_reg_field RxEmpty;  // default value is 1
   uvm_reg_field RxHigh;  // default value is 0
   uvm_reg_field RxFull;  // default value is 0
   uvm_reg_field SA;  // default value is 0
...
// build register fields for each register
       IntSrc.build();
      IntMask.build();
     TxStatus.build();
        TxLWM.build();
...
// add each register to the Memory I/O map
      // define default map
      default_map = create_map("default_map", 'h0, 4, UVM_LITTLE_ENDIAN, 1);
